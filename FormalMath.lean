...
surface includes the bounded M2.10 factored-integer-equation slice, the first bounded Project-4
natural-number operation-law examples, and supporting infrastructure. It does not claim curriculum
coverage or formalization completeness.
-/
