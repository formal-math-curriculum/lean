...
grep -Fq '"id":"SFART-M2-000001"' "$subject_dir/by-artifact.jsonl"
grep -Fq '"id":"SFLOC-M2-000002"' "$subject_dir/by-artifact.jsonl"
grep -Fq '"id":"SFLOC-M2-000001"' "$subject_dir/history.jsonl"
printf 'maintenance-migration:locator-chain:pass:fart=SFART-M2-000001;historical=SFLOC-M2-000001;current=SFLOC-M2-000002\n'

cat > "$RESULT" <<EOF
maintenance_evidence_version=2
...
stable_fart=SFART-M2-000001
historical_floc=SFLOC-M2-000001
current_floc=SFLOC-M2-000002
