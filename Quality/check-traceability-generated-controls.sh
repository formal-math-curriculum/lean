...
{"created_revision":"fixture-current","declaration_names":["Complex.eta"],"dependency_baseline_ref":"P2-DEP-M2.2-v1","file_path":"Mathlib/Data/Complex/Basic.lean","formal_artifact_ref":"FART-P2-000004","id":"FLOC-P2-000005","locator_status":"current","module_name":"Mathlib.Data.Complex.Basic","observed_at":"fixture-current","record_status":"active","repository":"leanprover-community/mathlib4","revision":"db584cd6d46c92f209a44c0f1c829460d327499d","schema_version":1,"source_kind":"dependency_repository","structural_anchors":[],"superseded_by_locator_refs":[],"supersedes_locator_refs":[]}
EOF
...
lake exe traceability query declaration Complex.eta --root "$ROOT" | grep -Fq 'FLOC-P2-000005'
