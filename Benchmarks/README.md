...
default 1800-second command timeout and 105-minute workflow timeout are anti-hang
...
- `P6_INTEGRATION_TIMEOUT_SECONDS` — fail-closed command timeout (default 1800);
